  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="">
                    <h5 class="card-header text-center">Update Driver</h5>
...
<?php 
               ...
               ?>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="driver_update.php">
   ...
   <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-lg float-right" name="add">Update Driver</button>
                                </div>
</div>
