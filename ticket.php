            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                      <div class="card-body">
                        <h3 class="text-center card-header"> Print Ticket </h3>
...
<?php 
               ...
               ?>
                        ...
                        <form id="login-form" class="form" action="ticketpdf.php" method="post">
...
while($row=mysqli_fetch_array($query_run)) {?>
  ...
  <div class="form-group">
                                ...
                                <select required="" class="form-control"  name="tto" id="">
                               <option>Select Your Starting Point</option>
                                <?php 
                                 //  session_start();
$con=mysqli_connect("127.0.0.1","root","","vehicle");
...
while($row=mysqli_fetch_array($query_run)) {?>
                            ...
                            <div class="form-group">
                                <label for="username" class="text-info">Ticket Date:</label><br>
                                <input type="date" class="form-control" name="ticket">
                            </div>
                            
                           
                            <div class="">
                         
                                <input type="submit" name="submit" class="btn btn-success btn-md" value="Print">
                            </div>
                        </form>
                        </div>
                    </div>
