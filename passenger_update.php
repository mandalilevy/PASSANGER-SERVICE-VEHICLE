...
<ul class="navbar-nav  mt-lg-0 ml-auto-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 mx-auto">
        ...
        <li class="nav-item">
     <a href="dashboard.php" style="color: white; font-family:Verdana; cursor: pointer; font-weight: bolder;" ><i class="fa fa-arrow-left fa-2x"></i></a>
      </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="">
                    <h5 class="card-header text-center">Update Customer Details</h5>
               ...
               ?>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="updatepass.php">
                                    ...
                                    <label style="font-weight: bold;">New Name</label>
                                 ...
                                 <div class="form-group">
                                    <label style="font-weight: bold;">New Phone Number</label>
                                    <input type="text" maxlength="10" class="form-control" name="dlno" required="">
                                </div>
                                <div class="form-group">
                                    <label style="font-weight: bold;">New Email Address</label>
                                    <input type="email" class="form-control" name="dage" required="">
                                </div>
...
<script type="text/javascript">
    function getOrders() {
        ...
        ajax.open("GET", "getdriver_id.php", true);
        ajax.send();
