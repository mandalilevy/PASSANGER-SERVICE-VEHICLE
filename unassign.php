            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                      <div class="card-body">
                        <h5 class="card-header text-center"> Unassign Vehicle </h5>
...
<?php 
               ...
               ?>
                        ...
                        <form id="login-form" class="form pt-3" action="unassignadd.php" method="post">
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
                            ...
                            <div class="">
                                ...
                                <input type="submit" name="submit" class="btn btn-warning btn-md" value="Unassign">
                            </div>
                        </form>
                        </div>
                    </div>
