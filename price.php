            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                      <div class="card-body">
                        <h6 class="text-center card-header"> <b>Add Destination Price</b></h6>

<?php 
                 if (@$_GET['Empty']==true)
                 {
                   ?>
                  <div style="font-weight: bolder;" class="card-title alert-light text-secondary text-danger text-center text-uppercase"><?php echo $_GET['Empty']?></div>
                   <?php 
                 }
               ?>
