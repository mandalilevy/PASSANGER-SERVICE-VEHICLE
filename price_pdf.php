...
$query=mysqli_query($con,"select * from price");
...
$pdf->Cell(59	,5,'PRICE LIST REPORT',0,1);//end of line
...
while($item=mysqli_fetch_array($query)){
	$pdf->Cell(50,5,$item['start'],1,0);
	$pdf->Cell(50,5,$item['end'],1,0);
	$pdf->Cell(55,5,$item['price'],1,1);
