 ...
 <div class="container" >
    <div class="row justify-content-center">
      <div class="col-lg-5 mt-4 p-2 rounded" style="background-color: white">
        <div class="">
          <div >
              <h5 class="card-title text-center" style="color: blue">PASSENGER RESET PASSWORD</h5>
             <?php 
       ...
       <form action="passangerreset.php" method="POST">       
 
        
  <div class="form-group row">
  <label for="em" class="col-sm-2 col-form-label"> ID NO.</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="em" name="email" placeholder="ID NO" required="">
  </div>
  </div>
  ...
  <div class="">
    ...
    <div style="float: right"> <a href="index.php">Login Here</a>  </div>   
  </div>
