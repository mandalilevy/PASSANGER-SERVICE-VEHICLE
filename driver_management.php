...
<ul class="navbar-nav  mt-lg-0 ml-auto-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 ml-auto">
       ...
       <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="assign_vehicle.php">Assign Vehicle</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
    <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="update_assingment.php">Update Vehicle Assignment</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
       <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="unassign.php">Unassign a Vehicle</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
     <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="update_driver.php">Update Driver</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
      ...
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="del_driver.php">Delete Driver</a>
      </li>
     <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight:;" class="nav-link" >|</a>
      </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="">
                    <h5 class="card-header text-center">Add New Driver</h5>
...
<?php 
               ...
               ?>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="adddriver.php">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label style="font-weight: bold;">Licence Number</label>
                                    <input type="text" class="form-control" name="dlno" required="">
                                </div>
                                <div class="form-group">
                                    <label style="font-weight: bold;">Driver Age</label>
                                    <input type="text" class="form-control" name="dage" required="">
                                </div>
                                <div class="form-group">
   ...
   <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-lg float-right" name="add">Add Driver</button>
                                </div>
</div>
