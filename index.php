    ...
    <div class="row">
      <div class="col-sm-9 col-md-5 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
              <h5 class="card-title text-center" style="color: blue">PASSENGER LOGIN</h5>
              <?php 
                 if (@$_GET['Empty']==true)
                 {
                   ?>
...
<?php 
              ...
              <form class="form-signin" method="post" action="passlogin.php">
              <div class="form-group row">
                  <label for="inputEmail">Passenger ID</label>
                  <input type="text" id="inputEmail" name="name" class="form-control" placeholder="Passanger ID" >           
              </div>
              <div class="form-group row">
              ...
              <b>Not yet Registered?</b><a href="passenger_login.php">Click me to Register</a> <br>
            <b>Forgot Your Password?</b><a href="passenger_resetpassword.php">Click me to Reset Password</a>
