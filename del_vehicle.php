...
<body class="bg-light">
 ...
 <ul class="navbar-nav  mt-lg-0 mx-auto">
      ...
      <li class="nav-item">
        <a href="vehicle_management.php" style="color: white; font-family:Verdana; cursor: pointer; font-weight: bolder;" ><i class="fa fa-arrow-left fa-2x"></i></a>
      </li>
 </ul>
 </div> 
 </nav>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                      <div class="card-body">
                        <h5 class="card-header text-center"> Delete Vehicle </h5>
...
<?php 
               ...
               ?>
                        ...
                        <form id="login-form" class="form" action="delete_vehicle.php" method="post">
...
while($row=mysqli_fetch_array($query_run)) {?>
                            ...
                            <div class="">
                                ...
                                <input type="submit" name="submit" class="btn btn-danger btn-md" value="Delete">
                            </div>
                        </form>
                        </div>
                    </div>
