  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="">
                    <h5 class="card-header text-center">Assign Vehicle</h5>
...
<?php 
               ...
               ?>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="assign_vehicle_add.php">
...
while($row=mysqli_fetch_array($query_run)) {?>
 ...
 ?>
   ...
   <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-lg float-right" name="add">Assign Vehicle</button>
                                </div>
