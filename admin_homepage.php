...
<ul class="navbar-nav  mt-lg-0 ml-auto-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 ml-auto">
    <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" href="vehicle_management.php" class="nav-link ">Vehicle Management</a>
      </li>
       <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
        <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" href="driver_management.php" class="nav-link">Driver Management</a>
      </li>
       <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
    ...
    <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="destination.php"> Destination Management</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="process_bookings.php">Booked Seats</a>
      </li>
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
       ...
       <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" href="reports.php"> Reports</a>
      </li>
     <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: ;" class="nav-link" >|</a>
      </li>
       <li class="nav-item">
         <?php 
echo '<a class="nav-link ml-auto" style="color: white; font-weight:; font-family:Verdana"  href="logout.php?logout">Sign Out <i class="fa fa-sign-out" aria-hidden="true"></i></a>';
  ?>
      </li>
 </ul>
 </div> 
